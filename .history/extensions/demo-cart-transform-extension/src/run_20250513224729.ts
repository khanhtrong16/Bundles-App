import { CartOperation } from "../generated/api";
...
function getMergeCartOperations(cart: InputQuery["cart"]): CartOperation[] {
...
function getComponentsInCart(
  cartLines: (typeof InputQuery)["cart"]["lines"],
...
function getMergeParentDefinitions(
  cart: InputQuery["cart"],
): ComponentParent[] {
...
function getComponentParents(
  variant: InputQuery["cart"]["lines"][number]["merchandise"] & {
...
function getExpandCartOperations(cart: InputQuery["cart"]): CartOperation[] {
